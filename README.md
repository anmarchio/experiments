...
* For more details on how to use the database api, see: [api/api.md](api/Readme.md)
...
* Run the following command to create an HTML report from the database:
```bash
python scripts\create_report_html.py --report "api\experiments.db" --report "report\results.html"
```
