...
def get_MAIPreform2_Spule0_0315_Upside_Thread_mean_pipeline(params, dataset_path=None, cross_name=None):
    pipeline_name = "MAIPreform2_Spule0_0315_Upside_Thread_mean_pipeline"
