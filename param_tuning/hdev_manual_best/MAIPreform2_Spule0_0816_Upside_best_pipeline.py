...
def get_MAIPreform2_Spule0_0816_Upside_best_pipeline(params, dataset_path=None, cross_name=None):
    ...
    core_code = (
            ...
            "<l>        WStep := max2(1, floor(RectWidth / MaskWidth))</l>\n"
            "<l>        HStep := max2(1, floor(RectHeight / MaskHeight))</l>\n"
            "<c></c>\n"
