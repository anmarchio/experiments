...
def get_MVTec_AD_Pill_Crack_best_pipeline(params, dataset_path=None, cross_name=None):
    ...
    core_code = (
            ...
            "<c></c>\n"
            "<l>        *WStep := RegWidth / MaskWidthCrop</l>\n"
            "<l>        *HStep := RegHeight / MaskHeightCrop</l>\n"
            "<c>        * Escape infinite loop</c>\n"
            "<l>        WStep := max2(1, floor(RegWidth / MaskWidthCrop))</l>\n"
            "<l>        HStep := max2(1, floor(RegHeight / MaskHeightCrop))</l>\n"
            "<c></c>\n"
