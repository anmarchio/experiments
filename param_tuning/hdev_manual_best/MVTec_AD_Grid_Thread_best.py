...
def get_MVTec_AD_Grid_Thread_best_pipeline(params, dataset_path=None, cross_name=None):
    pipeline_name = "MVTec_AD_Grid_Thread_best_pipeline"
    ...
    core_code = (
            ...
            "<c></c>\n"
            "<l>        *WStep := RegWidth / MaskHeightCrop</l>\n"
            "<l>        *HStep := RegHeight / MaskWidthCrop</l>\n"
            "<c>        * Escape infinite loop</c>\n"
            "<l>        WStep := max2(1, floor(RegWidth / MaskHeightCrop))</l>\n"
            "<l>        HStep := max2(1, floor(RegHeight / MaskWidthCrop))</l>\n"
            "<c></c>\n"
