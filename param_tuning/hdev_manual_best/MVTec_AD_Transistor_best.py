...
def get_MVTec_AD_Transistor_best_pipeline(params, dataset_path = None, cross_name=None):
    ...
    core_code = (
        ...
        "<c>        </c>\n"
        "<c>* CropSmallestRectangle</c>\n"
        "<l>        threshold(Image, Region1, MinGray, MaxGray)</l>\n"
        ...
        "<l>        threshold(Image, Region2, MinThresh, MaxThresh)</l>\n"
        "<c>        </c>\n"
        "<c>* Merge</c>\n"
        "<c>        *union2(Region2, Region1, Region)</c>\n"
        "<l>        Region := Region2</l>\n"
        "<c>        </c>\n"
        "<c>* Post: Closing -> SelectShape</c>\n"
        "<l>        gen_rectangle2(StructElement, 0, 0, Phi, A, B)</l>\n"
        "<l>        closing(Region1, StructElement, RegionClosed)</l>\n"
        "<c>        </c>\n"
        "<c>* SelectShape</c>\n"
        "<l>        select_shape(RegionClosed, Region1, Features, 'and', MinWidth, MaxWidth)</l>\n"
    )
