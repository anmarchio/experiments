...
def get_AirCarbon3_80_jpg_dark_5_best_pipeline(params, dataset_path=None, cross_name=None):
    ...
    core_code = (
            ...
            "<c>        </c>"
            "<l>        scale_image(ImageAmp1, ImageAmp1, 1, 128)</l>"
            ...
            "<c>        </c>"
            "<l>        scale_image(ImageAmp2, ImageAmp2, 1, 128)</l>"
