...
def get_CF_ReferenceSet_Small_Light_best_pipeline(params, dataset_path=None, cross_name=None):
    ...
    core_code = "<l>        median_weighted(Image, ImageMedian, MaskType, MaskSizeMedian)</l>\n" \
                    "<l>        sobel_amp(ImageMedian, Image, FilterType, MaskSizeSobel)</l>\n" \
                    "<c></c>" \
                    ...
                    "<l>        endif</l>\n" \
                    "<c>        </c>" \
                    "<l>        local_threshold(Image, Region, Method, LightDark, ['mask_size', 'scale' ], [MaskSizeThresh, Scale])</l>\n" \
                    "<c>        </c>" \
                    "<c>        * Closing</c>" \
                    "<l>        *tuple_ceil(A + 1, shape_param0_ceil)</l>\n" \
                    "<l>        gen_disc_se(StructElement, 'byte', A, B, C)</l>\n" \
